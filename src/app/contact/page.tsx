  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 min-h-[calc(100vh-150px)]">
      ...
      <motion.div
        ...
        className="space-y-8 max-w-xl mx-auto mb-24"
      >
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
        >
          <div className="w-14 h-14 bg-gradient-to-br from-gray-900 to-black rounded-full flex items-center justify-center">

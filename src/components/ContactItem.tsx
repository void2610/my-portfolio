...
import { fadeInUp, springTransition, createStaggerDelay, DURATION, SCALE } from "@/config/animations";
...
export default function ContactItem({
  ...
  return (
    <motion.a
      ...
      animate="animate"
      transition={{ 
        opacity: { duration: DURATION.DEFAULT, delay: createStaggerDelay(index) },
        y: { duration: DURATION.DEFAULT, delay: createStaggerDelay(index) },
